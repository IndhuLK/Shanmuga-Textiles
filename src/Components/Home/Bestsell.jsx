        ...
        <div className="font-family max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center px-4">
          {features.map((feature, index) => (
            <div key={index} className="space-y-4">
              ...
              <h3 className="text-md md:text-lg font-semibold mb-5">{feature.title}</h3>
          ...
          {products.map((product, index) => (
            <div key={index} className="p-10">
              <div className="bg-white  transition-all duration-300  w-[278px]">
                ...
                />
                <div className="p-4">
                  <h3 className="font-medium md:text-md text-sm mt-1">{product.title}</h3>
                  <p className="text-gray-600 mt-3 md:text-md text-sm">{product.price}</p>
                  <button variant="contained" className="mt-4 px-4 w-full py-2 text-center border
